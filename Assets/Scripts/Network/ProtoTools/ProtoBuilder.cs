...
namespace Network.ProtoTools
{
    ...
    public static class ProtoBuilder
    {
        ...
        //     /// </summary>
        //     public static LocalSyncPackage BuildRequest(LocalBattleEvent battleEventID )
        //     {
        ...
        {
            /// <summary>
            /// 客户端->服务端同步包-ACK请求包ClientSyncRequest-事件包HeartBeatPackage(快捷创建Protobuf对象)
            /// </summary>
            ...
            /// <summary>
            /// 客户端->服务端同步包-ACK请求包ClientSyncRequest-连接请求包ConnectRequestPackage(快捷创建Protobuf对象)
            /// </summary>
            ...
            /// <summary>
            /// 服务端->客户端同步包-ACK回应包ClientSyncRequest-连接回应包ConnectResponsePackage(快捷创建Protobuf对象)
            /// </summary>
            public static RemoteSyncPackage BuildConnectResponse(String content)
            {
                return new RemoteSyncPackage
                {
                    EventID = RemoteSyncEvent.ClientResponse,
                    ClientPackage = new ClientSyncResponse
                    {
                        EventID = RemoteClientEvent.ConnectResponse,
