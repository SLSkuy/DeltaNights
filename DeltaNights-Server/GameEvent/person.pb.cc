...
const uint32_t TableStruct_person_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::person::Person, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::person::Person, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::person::Person, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::person::Person, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::person::Person, _impl_.email_),
  0,
  2,
  1,
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::person::Person)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::person::_Person_default_instance_._instance,
};
...
const ::_pbi::DescriptorTable descriptor_table_person_2eproto = {
    false, false, 73, descriptor_table_protodef_person_2eproto,
    "person.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "person.Person.name");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "person.Person.email");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:person.Person)
  size_t total_size = 0;
...
template<> PROTOBUF_NOINLINE ::person::Person*
Arena::CreateMaybeMessage< ::person::Person >(Arena* arena) {
